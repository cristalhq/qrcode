...
var (
	...
	comment   = []byte("Software\x00QR-PNG http://qr.swtch.com/")
)
...
func (b *bitWriter) codex(c, val int, nx uint) {
	b.hcode(c + val>>nx)
...
func afinish(a, b uint32) uint32 { return b<<16 | a }
